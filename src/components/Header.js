  ...
  return (
    <div className="font-sans flex flex-row justify-center items-center m-6 p-20">
      <p className="font-light text-2xl p-6 w-3/4 text-left">
        ...
        background in the arts and a deep understanding of human behavior, I am
        able to approach problem-solving from multiple angles and create
        intuitive and user-friendly solutions. Whether I'm developing new
        applications or optimizing existing ones, I am driven by a passion for
        creating functional and aesthetically pleasing software. I am excited to
        bring my diverse skill set and fresh perspective to any team, and I am
